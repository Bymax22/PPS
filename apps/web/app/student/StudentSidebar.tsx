...
const menuItems = [
  ...
  { name: 'Assignments', href: '/student/assignments', icon: FaTasks },
  { name: 'Exams', href: '/student/exams', icon: FaFileAlt },
  { name: 'Learning Materials', href: '/student/materials', icon: FaGraduationCap },
  { name: 'Grades & Attendance', href: '/student/grades', icon: FaChartLine },
  { name: 'Study Groups', href: '/student/groups', icon: FaUsers },
  { name: 'Gamification', href: '/student/gamification', icon: FaTrophy },
